        ...
        try {
            ...
            if (resource.length() > 0) {
                if (resource.startsWith("Login")) {
                    ...
                    path = resource.substring(0, resource.indexOf('.') - 1)
                    + resource.substring(resource.indexOf('.') + 1, 1).toUpperCase();
                }
                path += "Servlet";
            ...
            log("FilterDispatcher _ General" + e.getMessage());
        } finally {
            if (path != null) {
